...
import os
import json
from PyQt5.QtWidgets import QLabel, QComboBox, QListWidget, QPushButton, QCheckBox, QLineEdit,QTextEdit,QSizePolicy
...
def load_algorithm_parameters(self):
    ...
    try:
        ...
        for param in self.current_parameters:
            ...
            1.下拉框控件"column_select"
            2.多选下拉框控件"multi_column_select"
            3.颜色选择控件"color_select"
            4.
            """
